...
##
LABEL \
	name="cytopia's PerconaDB 5.6 Image" \
	image="percona-5.6" \
	vendor="cytopia" \
	license="MIT" \
...
ENV YUM_REPO_URL="https://www.percona.com/redir/downloads/percona-release/redhat/latest/percona-release-0.1-4.noarch.rpm"
